...
-- vim.keymap.set('n', '<leader>a', ':Lf<enter>', { desc = 'Open LF' })
vim.keymap.set('n', '<leader>v', ':vs<enter>', { desc = 'Vertical Split' })
vim.keymap.set('n', '<leader>-', ':split<enter>', { desc = 'Horizontal Split' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'go', 'python', 'php' },
